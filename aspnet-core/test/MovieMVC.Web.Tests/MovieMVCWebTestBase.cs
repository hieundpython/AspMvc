...
namespace MovieMVC.Web.Tests
{
    public abstract class MovieMVCWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MovieMVCWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MovieMVCWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MovieMVCDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MovieMVCDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MovieMVCDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MovieMVCDbContext, Task<T>> func)
        {
            T result;
